...
class AsciiFilter {
  constructor(renderer, { fontSize, fontFamily, charset, invert } = {}) {
    ...
    // FIX 1: willReadFrequently=true tells the browser to keep this canvas
    // in CPU RAM, making the 60fps getImageData() calls in asciify() instantaneous.
...
class CanvasTxt {
  constructor(txt, { fontSize = 200, fontFamily = 'Arial', color = '#fdf9f3' } = {}) {
    this.canvas = document.createElement('canvas');
    // FIX 2: willReadFrequently=true here too, since this canvas is re-rendered
    // every single animation frame via texture.needsUpdate = true in render().
    this.context = this.canvas.getContext('2d', { willReadFrequently: true });
    this.txt = txt;
