...
const Ferrofluid: React.FC<FerrofluidProps> = ({
  className, dpr, paused = false, colors = ['#ffffff', '#ffffff', '#ffffff'],
  speed = 0.5, scale = 1.6, turbulence = 1, fluidity = 0.1, rimWidth = 0.2,
  sharpness = 2.5, shimmer = 1.5, glow = 2, flowDirection = 'down',
  opacity = 1, mouseInteraction = true, mouseStrength = 1, mouseRadius = 0.35,
  ...
  useEffect(() => {
    ...
    const uniforms = {
      ...
      uMouseColor: { value: avg }, uFlow: { value: flowVec(flowDirection || 'down') },
    ...
    const onPointerMove = (e: PointerEvent) => {
      ...
      if (mouseDampening && mouseDampening <= 0) uniforms.iMouse.value = [x, y];
    };
